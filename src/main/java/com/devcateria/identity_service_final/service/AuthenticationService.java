...
import com.devcateria.identity_service_final.repository.InvalidatedRepository;
...
public class AuthenticationService {
    ...
    public InstroSpecResponse instrospect(IntroSpectRequest request) throws JOSEException, ParseException {
        ...
        return InstroSpecResponse.builder().valid(isValid).build();
    }
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) throws KeyLengthException {
        ...
        if (!authenticated) throw new AppExeption(ErrorCode.UNAUTHENTICATED);
    ...
    public AuthenticationResponse refreshToken(RefreshRequest request) throws ParseException, JOSEException {
        ...
        var user =
                userRepository.findByUsername(username).orElseThrow(() -> new AppExeption(ErrorCode.UNAUTHENTICATED));
    ...
    private SignedJWT verifyToken(String token, boolean isRefresh) throws JOSEException, ParseException {
        ...
        if (!(verified && expityTime.after(new Date()))) throw new AppExeption(ErrorCode.UNAUTHENTICATED);
